...
$path = Split-Path -parent "C:\temp\ExportADUsers\*.*"
...
$csvfile = $path + "\DarwinADUsers_$logDate.csv"
...
$SearchBase = "OU=Standard Users,OU=SKYCITYDarwin,DC=SkyCityDarwin,DC=SCEG,DC=com"
...
$ADServer = 'sky-drw-ad08.skycitydarwin.sceg.com'
